...
From Undecidability.FOL.Util
     Require Import Syntax Syntax_facts FullTarski_facts FullDeduction FullDeduction_facts.

From Undecidability.FOL
     Require Import Util.Aczel Util.ZF_model ZF minZF FST.
...
Section Model.
  ...
  Instance min_model' : interp sig_func_empty ZF_pred_sig V.
  Proof.
    split.
    - intros [].
    - intros [].
